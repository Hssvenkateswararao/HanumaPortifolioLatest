          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">hanumasaisatyanarayana@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 6300564674</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Nidadavole, A.P</p>
                </div>
              </div>
            </div>
            ...
            {/* <div className="pt-8 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a 
                  href="#" 
                  className="bg-white p-3 rounded-lg shadow-md hover:shadow-lg hover:bg-blue-50 transition-all duration-200 group"
                >
